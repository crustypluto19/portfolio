...
export default function Home() {
  ...
  return (
    <div ref={ref} className='snap snap-y snap-mandatory h-screen w-screen overflow-x-hidden scrollbar-hide transition ease-in-out duration-500'>
      ...
      <section className='snap-center h-screen w-screen scroll-mt-[9.5rem] bg-yellow-500'>
        <AboutHome />
      </section>
      <section className='snap-center h-screen w-screen scroll-mt-[9.5rem] bg-cyan-300'>
        <WorkHome />
      </section>
    </div>
  )
